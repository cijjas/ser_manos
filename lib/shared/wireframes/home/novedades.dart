  ...
  Widget build(BuildContext context) {
    return AppHeader(
      ...
      body: Column(
        ...
        children: [
          const SizedBox(height: 8), // TODO ask about sizedBox for spacing
          Expanded(child:
            ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return Padding(padding:  const EdgeInsets.symmetric(vertical: 12.0),
                  child: CardNovedades(type: newsPiece.type,
                      name: newsPiece.name, description: newsPiece.description, imgUrl: newsPiece.imageUrl));
              },
            )
          )
        ]
